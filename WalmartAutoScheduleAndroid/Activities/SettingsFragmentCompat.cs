...
{
    [Register("com.andrewsstudios.automagicwalmartscheduletracker.walmartAutoScheduleAndroid.SettingsFragmentCompat")]
    public class SettingsFragmentCompat : PreferenceFragmentCompat
    {
        ...
        SwitchPreferenceCompat addNotification;
        SwitchPreferenceCompat deleteNotification;
        SwitchPreferenceCompat updateNotification;
        SwitchPreferenceCompat errorNotification;
        SwitchPreferenceCompat showDaysOffSwitch;
        ...
        {
            // Add  preferences.
            AddPreferencesFromResource(Resource.Xml.settingscompat);
            ...
            //timepref = FindPreference("timesetting");
            ...
            addNotification = (SwitchPreferenceCompat)FindPreference("addshiftnotification");
            updateNotification = (SwitchPreferenceCompat)FindPreference("updateshiftnotification");
            deleteNotification = (SwitchPreferenceCompat)FindPreference("deleteshiftnotification");
            errorNotification = (SwitchPreferenceCompat)FindPreference("errornotification");
            reminderList = (ListPreference)FindPreference("reminder");
            showDaysOffSwitch = (SwitchPreferenceCompat)FindPreference("showDaysOff");
